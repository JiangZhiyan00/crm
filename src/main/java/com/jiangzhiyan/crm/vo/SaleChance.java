...
public class SaleChance {
    ...
    private String assignManTrueName;
    ...
    public String getAssignManTrueName() {
        return assignManTrueName;
    }

    public void setAssignManTrueName(String assignManTrueName) {
        this.assignManTrueName = assignManTrueName;
    }
}