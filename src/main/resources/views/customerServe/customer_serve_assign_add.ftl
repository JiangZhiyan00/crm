...
<div align="justify">
    <form class="layui-form" style="width:80%;">
        ...
        <div class="layui-form-item layui-row">
            <div class="layui-col-xs6">
                ...
                <div class="layui-input-block">
                    <select name="serveType"  id="serveType" disabled>
            ...
            <div class="layui-col-xs6">
                ...
                <div class="layui-input-block">
                    <input type="text" class="layui-input"
                           name="customer" id="customer"  value="${(customerServe.cusName)!}" disabled>
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item layui-row">
            ...
            <div class="layui-input-block">
                <textarea  name="serviceRequest" class="layui-textarea" disabled>${(customerServe.serviceRequest)!}</textarea>
            </div>
        </div>
        ...
        <div class="layui-form-item layui-row">
            ...
            <div class="layui-input-block">
                <input type="text" class="layui-input"
                       name="overview" id="overview"  value="${(customerServe.overview)!}" disabled>
            </div>
        </div>

        <div class="layui-form-item layui-row">
            <label class="layui-form-label">
                <span style="color: red">*</span>分配给</label>
            <div class="layui-input-block">
        ...
        <div class="layui-form-item layui-row layui-col-xs12">
            <div class="layui-input-block" style="float: left">
                <button class="layui-btn layui-btn-lg" lay-submit lay-filter="updateCustomerServe">
