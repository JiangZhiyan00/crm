...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-side layui-bg-black">
        <div class="layui-side-scroll layui-left-menu">
            ...
            <#--freemarker内建函数seq_contains,用法:
            (详情见官方文档:http://freemarker.foofun.cn/ref_builtins_sequence.html#ref_builtin_seq_contains)
                ...
                <ul class="layui-nav layui-nav-tree layui-left-nav-tree layui-this" id="currency">
                    <#if optValues?seq_contains("10")>
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <#if optValues?seq_contains("1010")>
                                    <dd>
                                        <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd"
                                           data-tab-mpi="m-p-i-1" data-tab="saleChance/index" target="_self"><i
                                                    class="fa fa-tty"></i><span
                                                    class="layui-left-nav"> 营销机会管理</span></a>
                                    </dd>
                                </#if>
                                <#if optValues?seq_contains("1020")>
                                    <dd>
                                        <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd"
                                           data-tab-mpi="m-p-i-2" data-tab="cusDevPlan/index" target="_self"><i
                    ...
                    <li class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            ...
                            <#if optValues?seq_contains("2010")>
                                <dd>
                                    <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd"
                    ...
                    <li class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            ...
                            <#if optValues?seq_contains("5010")>
                                <dd>
                                    <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd"
                            ...
                            <#if optValues?seq_contains("5020")>
                                <dd class="">
                                    <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd"
                            ...
                            <#if optValues?seq_contains("5030")>
                                <dd class="">
                                    <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd"
                            ...
                            <#if optValues?seq_contains("5050")>
                                <dd class="">
                                    <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd"
